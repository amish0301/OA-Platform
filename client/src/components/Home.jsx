    ...
    <>
      <div className='w-full min-h-screen px-14 gap-10 flex items-center'>
        <div className='w-full md:w-1/2 pl-10 md:mb-32'>
          ...
          {/* test button */}
          <button className='flex items-center gap-2 text-lg mt-14 py-3 px-10 bg-blue-600 text-white font-semibold rounded-lg shadow-md shadow-black/50 hover:bg-blue-800 hover:transition-colors duration-300'>Give Test
