...
const QuestionList = ({ questions = [], isPreview = false }) => {
    return (
        <div>
            {
                            ...
                            isPreview && q.options?.map((o, index) => (
                                <div key={index} className='flex items-center justify-start ml-5'>
                                    <div className='flex items-center mr-2'>
                                        <input type="checkbox" className='rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-offset-0 focus:ring-blue-200' checked={q.answer == index+1} />
